...
<html>
	...
	<body class="home">
		...
		<div id="container">
			...
			<!-- Início topo e menu de navegação -->
			<div id="topo">
							...
							<ul id="lista-noticias">
								<li>
									<a href="./paginas/saude.php">
										<img src="./imagens/italia.jpg" width="80">
								...
								<li>
									<a href="./paginas/esportes.php">
										<img src="./imagens/bem.jpg" width="80">
				...
				<div id="secundario">
					...
					<div class="caixa entrevista">
						...
						<div class="caixa-conteudo">
							...
							<img class="imagem-principal" src="imagens/especialistas.jpg" width="100%">
					...
					<div class="caixa">
						...
						<div class="caixa-conteudo">
							...
							<ul id="lista-noticias">
								<li>
									<a href="./paginas/saude.php">
										<img src="imagens/vaci.jpg" width="80">
